# Generated by Django 3.0.7 on 2020-12-01 12:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('itype', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.IndustriesModel')),
                ('person', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='app.RegistrationModel')),
            ],
        ),
    ]
